	...
	function bootstrap_setup(){
		...
		class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
			...
			function start_lvl( &$output, $depth = 0, $args = array() ) {
				...
				$output	   .= "\n$indent<ul class=\"rd-navbar-dropdown rd-navbar-open-right\">\n";
			...
			function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
				...
				$classes[] = ($args->has_children) ? 'rd-navbar--has-dropdown rd-navbar-submenu' : '';
        ...
        $output .= ($args->has_children) ? '<span class="rd-navbar-submenu-toggle"></span>' : '';
			}
