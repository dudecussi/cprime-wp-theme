...
var userAgent = navigator.userAgent.toLowerCase(),
    ...
    plugins = {
        ...
        googleMapAPI: '//maps.google.com/maps/api/js?key=AIzaSyBG-QHyWNy3KVZccxYggihLJgI9nT0ZKlg',
        googleMapLibraries: '//maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&key=AIzaSyBG-QHyWNy3KVZccxYggihLJgI9nT0ZKlg',
        ...
        for (i = 0; i < plugins.mailForm.length; i++) {
            var $currentForm = $(plugins.mailForm[i]),
                mailFormSettings = {
                    ...
                    msg: {
                        'MF000': 'Obrigado, envio realizado!',
                        'MF001': 'Recipients are not set!',
                        'MF002': 'Form will not work locally!',
                        'MF003': 'Please, define email field in your form!',
                        'MF004': 'Please, define type of your form!',
                        'MF254': 'Something went wrong with PHPMailer!',
                        'MF255': 'Ops! Algo de errado aconteceu.'
                    }
                },
        ...
        $.getScript(plugins.googleMapLibraries)
            .done(function () {
                ...
                var map = new google.maps.Map(document.getElementById('map'), {
                    center: {lat: -23.55026, lng: -46.63556},
                    zoom: 13,
                    icon: image,
                    styles: [/*{
                        "featureType": "administrative",
                ...
                var image = $baseURL + '/assets/images/gmap_marker.png';
